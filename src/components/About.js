...
function About(props) {
    ...
    return (
        <section style={{ Background: "#000", marginTop: "100px" }}>
            <div className="container px-5 py-10 mx-auto">
                <div className="text-center mb-20 cc-profile-image">
                    ...
                    <h1 className="title-font sm:text-4xl text-3xl mb-4 font-small text-white">
                        ...
                        apps.</h1>
                    <h2 className="title-font sm:text-4xl  mb-4 font-small text-white"> Click on the voice icon at the bottom left corner &amp; say <span style={{ fontWeight: 'bolder', fontSize: '35px', color: "yellow" }}>PLEASE HELP</span><br />
            ...
            <div class=" flex flex-wrap mb-2  overflow-hidden justify-items-center" style={{ margin: "20px", padding: "20px" }}>
                <div class="md:flex bg-white rounded-xl shadow-md" style={{ padding: "10px" }}>
                    <div class="p-8">
                        ...
                        <div style={{ padding: "10px", margin: "5px", color: "black" }}>
                            ...
                            <p>I have problem-solving abilities to overcome glitches with creative solutions that are strategically designed to last long-term.<br />I equally have the ability to listen carefully to
                                feedback and to determine modifications for optimal user-function. &nbsp;&nbsp;&nbsp;I love coding</p><br />
